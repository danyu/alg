...
public class InterleaveString {
	...
	public boolean isInterleave(String s1, String s2, String s3) {
		...
		if(s1==null) return s2==s3;
		if(s2==null) return s1==s3;
		...
		if(copy.substring(0).equals(s2)) return true;
		...
		if(iS2!=s2.length()) return false;
		if(copy.substring(0).equals(s1)) return true;
